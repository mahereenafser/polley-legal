        ...
        <div className="mx-auto flex max-w-[800px] flex-col items-center text-center">
          ...
          <div className="mt-10 flex w-full justify-center sm:w-auto">
            <Link
              ...
              className="inline-block w-full rounded-lg bg-[#F4CCBA] py-4 px-10 text-center font-semibold text-text-primary transition-transform duration-300 ease-in-out hover:scale-102 hover:brightness-95 focus:outline-none focus:ring-2 focus:ring-[#F4CCBA] focus:ring-offset-2 focus:ring-offset-[#2C4A47] sm:w-auto"
            >
              Free Consultation
            </Link>
          </div>
